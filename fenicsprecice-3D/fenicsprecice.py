...
class Adapter:
    ...
    def read_data(self):
        ...
        if not self._empty_rank:
            ...
            assert (read_data is not None), "read_data is none, uh oh stinky"
    ...
    def initialize(self, coupling_subdomain, read_function_space=None, write_object=None, fixed_boundary=None):
        ...
        # moved from under the _write_function_* initialisations
        ...
        if self._fenics_dims != 2 and self._fenics_dims != 3:
            raise Exception("This modified FEniCS-preCICE adapter supports 2D and 3D cases only.")
